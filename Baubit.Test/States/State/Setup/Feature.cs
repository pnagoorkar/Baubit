...
namespace Baubit.Test.States.State.Setup
{
    public class Feature : IFeature
    {
        ...
        [
            ...
            new Baubit.Caching.InMemory.DI.Module<MyStatefulType.States>(ConfigurationSource.Empty),
            new Baubit.Caching.InMemory.DI.Module<StateChanged<MyStatefulType.States>>(ConfigurationSource.Empty),
