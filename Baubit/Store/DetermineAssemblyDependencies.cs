...
//    {
//        public static async Task<Result<Package1>> DetermineAssemblyDependenciesAsync(AssemblyDependencyDeterminationContext context)
//        {
//            try
//            {
...
//        private static async Task<Result<Package1>> BuildPackageFromProjectAssetsConfiguration(IConfiguration configuration, AssemblyDependencyDeterminationContext context)
//        {
//            try
//            {
...
//                var package2s = new List<Package>();
...
//            List<Package1> dependencies = new List<Package1>();
...
//            package = new Package1(new AssemblyName { Name = keyParts[0], Version = new Version(keyParts[1]) },
//                                  dllRelativePath,
