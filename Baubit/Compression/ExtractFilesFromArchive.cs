...
//    public class FileExtractionContext
//    {
//        public string Source { get; init; }
//        public string Destination { get; init; }
//        public Expression<Func<ZipArchiveEntry, bool>> Criteria { get; init; }
...
//        public FileExtractionContext(string source,
//                                     string destination,
//                                     Expression<Func<ZipArchiveEntry, bool>> criteria,
//                                     bool retainPaths = true,
//                                     bool overwrite = false,
...
//    {
//        public static async Task<Result<List<string>>> RunAsync(this FileExtractionContext context)
//        {
//            try
//            {
//                List<string> extractedFiles = new List<string>();
